...
The core parsers handle untrusted input by design, so they've been fuzz
tested against tens of thousands of corrupted files with no crashes or
hangs found. See [`SECURITY_AUDIT.md`](SECURITY_AUDIT.md) for the full
write-up of what was checked and fixed.
